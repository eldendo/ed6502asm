...
//            if pass=1 then exit;
            ...
            while tmp<>nil do
                ...
                if pass=1 then val := $FFFF else err('label not found')
        end;
        ...
        begin
            case mnem of
                ...
                pi_EQU: begin consume(s_num); if pass=1 then labList^.value := val end;
                pi_END: sym := s_eof;
                pi_DB: begin 
                            DBitem;
